...
\usepackage{multicol}%für mehrspaltige Aufzählungen
\usepackage{subfigure} %Bilder zusamenbringen
\usepackage{amsmath}%Erweiterung für Mathematik
\usepackage{listings}% Quellcode einbinden
\usepackage{wrapfig}%Bilder in Texten umfließen lassen
\usepackage{tabularx}%Tabellendefinition
